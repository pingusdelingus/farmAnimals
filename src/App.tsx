    ...
    <div className="min-h-screen flex flex-col bg-gray-900">
      <div className="flex-1">
        ...
        <div className="grid grid-cols-2 gap-6 p-6">
          <AspectRatioImage src={dog1} alt="Dog 1" ratio={4/ 3} />
          <AspectRatioImage src={dog2} alt="Dog 2" ratio={4/ 3} />
        </div>

        <div className="flex flex-col items-center justify-center">
          <Button className="mb-8 bg-blue-600 hover:bg-blue-700">
            Click ME RIGHT NOW LIL BRO
          </Button>
        </div>
        ...
        <div className="flex items-start space-x-2 px-6">
          ...
          <div className="grid gap-1.5 leading-none">
            <label
              htmlFor="terms1"
              className="text-sm text-gray-200 font-medium leading-none peer-disabled:cursor-not-allowed"
            >
